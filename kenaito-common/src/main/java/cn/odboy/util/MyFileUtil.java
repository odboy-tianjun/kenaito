 ...
 *
 */
public class MyFileUtil extends cn.hutool.core.io.FileUtil {
    ...
    public static File toFile(MultipartFile multipartFile) {
        ...
        try {
            ...
            log.error("MultipartFile保存为本地file失败", e);
        }
        return file;
    }
    ...
    public static File upload(MultipartFile file, String filePath) {
        ...
        try {
            ...
            log.error("upload 保存为本地file失败", e);
        }
        return null;
    }
    ...
    public static String verifyFilename(String fileName) {
        ...
        String containsStr = "Windows";
        if (System.getProperty(propertyName).startsWith(containsStr)) {
