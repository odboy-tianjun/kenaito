...
public class TokenFilter extends GenericFilterBean {
     ...
     * @param onlineUserRepository 用户在线
     * @param userCacheManager     用户缓存工具
     */
    public TokenFilter(TokenProvider tokenProvider, SecurityProperties properties, OnlineUserRepository onlineUserRepository, UserCacheManager userCacheManager) {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain)
        ...
        if (StrUtil.isNotBlank(token)) {
            ...
            try {
                ...
                onlineUserDto = onlineUserRepository.getOne(loginKey);
